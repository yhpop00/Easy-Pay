...
if($type){
	...
	if($checktype == 'alipay' && $type == 'alipay' && in_array('4',$apptype)){
		$openId = alipayOpenId($submitData['channel']);
		$direct = '1';
	}elseif($checktype == 'wxpay' && $type == 'wxpay' && in_array('2',$apptype)){
		$openId = weixinOpenId($submitData['channel']);
		$direct = '1';
	}elseif($checktype == 'qqpay' && $type == 'qqpay' && in_array('2',$apptype)){
		$direct = '1';
	}
