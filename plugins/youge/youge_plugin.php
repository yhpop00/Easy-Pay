...
{
	static public $info = [
		'name'        => 'youge', //支付插件英文名称，需和目录名称一致，不能有重复
		'showname'    => '友格云', //支付插件显示名称
		'author'      => '友格云', //支付插件作者
		'link'        => 'https://www.youge.cloud/', //支付插件作者链接
		'types'       => ['alipay','wxpay','bank','【多通道一键申请】'], 		
	...
	static private function getApiUrl(){
		...
		$apiurl = 'https://saas-api.youge.cloud';
